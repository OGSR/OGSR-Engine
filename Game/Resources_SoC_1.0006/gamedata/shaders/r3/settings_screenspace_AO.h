...
#define G_SSDO_DETAILED_RADIUS 0.0f // Detailed search radius. [ 1.0f = 100% ]
#define G_SSDO_DETAILED_WEAPON_RADIUS 0.4f // Detailed serach radius for weapons. [ 1.0f = 100% ]