...
TEMPLATE_SPECIALIZATION
IC bool CPathManagerTemplate::actual(const _vertex_id_type /*start_vertex_id*/, const _vertex_id_type /*dest_vertex_id*/) const { return (m_actuality); }
...
TEMPLATE_SPECIALIZATION
IC bool CPathManagerTemplate::check_vertex(const _vertex_id_type vertex_id) const { return (m_graph->valid_vertex_id(vertex_id)); }
