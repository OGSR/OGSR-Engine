...
#include "stalker_movement_manager_obstacles.h" //"stalker_movement_manager_smart_cover.h"
...
private:
    stalker_movement_manager_obstacles /*stalker_movement_manager_smart_cover*/ const* m_movement;
    actor* m_actor;
    door_state m_state;
