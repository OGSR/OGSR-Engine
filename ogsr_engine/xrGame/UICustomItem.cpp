...
//--------------------------------------------------------------------
void CUICustomItem::Render(const Fvector2& pos, u32 color) { Render(pos, color, iVisRect.x1, iVisRect.y1, iVisRect.x2, iVisRect.y2); }
//--------------------------------------------------------------------
...
Frect CUICustomItem::GetOriginalRect() const { return iOriginalRect; }
