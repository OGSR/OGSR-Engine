...
IC void CALifeSimulatorBase::add_story_object(CSE_ALifeDynamicObject* object, ALife::_STORY_ID _story_id) { story_objects().add(_story_id, object, true); }

IC bool CALifeSimulatorBase::is_unloading() const { return m_unloading; }
