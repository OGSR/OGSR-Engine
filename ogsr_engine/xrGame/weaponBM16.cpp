...
void CWeaponBM16::PlayAnimShoot()
{
	...
	xr_strconcat(guns_shoot_anm, "anm_shoot", (this->IsZoomed() && !this->IsRotatingToZoom()) ? "_aim" : "", IsMisfire() ? "_jammed_" : "_", std::to_string(m_magazine.size()).c_str());
...
void CWeaponBM16::PlayAnimIdleMoving()
{
	...
	case 1: PlayHUDMotion({ IsMisfire() ? "anm_idle_moving_jammed_1" : "nullptr", "anim_idle_moving_1", "anim_idle_moving", "anim_idle_1", "anm_idle_moving_1" }, true, GetState()); break;
	case 2: PlayHUDMotion({ IsMisfire() ? "anm_idle_moving_jammed_2" : "nullptr", "anim_idle_moving_2", "anim_idle_moving", "anim_idle_2", "anm_idle_moving_2" }, true, GetState()); break;
	}
}
...
void CWeaponBM16::PlayAnimIdleMovingSlow()
{
	switch (m_magazine.size())
	{
	case 0: PlayHUDMotion({ IsMisfire() ? "anm_idle_moving_slow_jammed_0" : "nullptr", "anm_idle_moving_slow_0", "anim_idle_moving", "anim_idle", "anm_idle_moving_0" }, true, GetState()); break;
	case 1: PlayHUDMotion({ IsMisfire() ? "anm_idle_moving_slow_jammed_1" : "nullptr", "anm_idle_moving_slow_1", "anim_idle_moving_1", "anim_idle_moving", "anim_idle_1", "anm_idle_moving_1" }, true, GetState()); break;
	case 2: PlayHUDMotion({ IsMisfire() ? "anm_idle_moving_slow_jammed_2" : "nullptr", "anm_idle_moving_slow_2", "anim_idle_moving_2", "anim_idle_moving", "anim_idle_2", "anm_idle_moving_2" }, true, GetState()); break;
	}
}
...
void CWeaponBM16::PlayAnimIdleMovingCrouch()
{
	switch (m_magazine.size())
	{
	case 0: PlayHUDMotion({ IsMisfire() ? "anm_idle_moving_crouch_jammed_0" : "nullptr", "anm_idle_moving_crouch_0", "anim_idle_moving", "anim_idle", "anm_idle_moving_0" }, true, GetState()); break;
	case 1: PlayHUDMotion({ IsMisfire() ? "anm_idle_moving_crouch_jammed_1" : "nullptr", "anm_idle_moving_crouch_1", "anim_idle_moving_1", "anim_idle_moving", "anim_idle_1", "anm_idle_moving_1" }, true, GetState()); break;
	case 2: PlayHUDMotion({ IsMisfire() ? "anm_idle_moving_crouch_jammed_2" : "nullptr", "anm_idle_moving_crouch_2", "anim_idle_moving_2", "anim_idle_moving", "anim_idle_2", "anm_idle_moving_2" }, true, GetState()); break;
	}
}
...
void CWeaponBM16::PlayAnimIdleMovingCrouchSlow()
{
	switch (m_magazine.size())
	{
	case 0: PlayHUDMotion({ IsMisfire() ? "anm_idle_moving_crouch_slow_jammed_0" : "nullptr", "anm_idle_moving_crouch_slow_0", "anm_idle_moving_crouch_0", "anim_idle_moving", "anim_idle", "anm_idle_moving_0" }, true, GetState()); break;
	case 1: PlayHUDMotion({ IsMisfire() ? "anm_idle_moving_crouch_slow_jammed_1" : "nullptr", "anm_idle_moving_crouch_slow_1", "anm_idle_moving_crouch_1", "anim_idle_moving_1", "anim_idle_moving", "anim_idle_1", "anm_idle_moving_1" }, true, GetState()); break;
	case 2: PlayHUDMotion({ IsMisfire() ? "anm_idle_moving_crouch_slow_jammed_2" : "nullptr", "anm_idle_moving_crouch_slow_2", "anm_idle_moving_crouch_2", "anim_idle_moving_2", "anim_idle_moving", "anim_idle_2", "anm_idle_moving_2" }, true, GetState()); break;
	}
}
		...
		if (!HudBobbingAllowed()) {
			if (const u32 state = pActor->get_state(); state & mcAnyMove) {
				if (IsScopeAttached())
					...
					return xr_strconcat(guns_bm_aim_anm, "anm_idle_aim_moving", (state & mcFwd) ? "_forward" : ((state & mcBack) ? "_back" : ""), (state & mcLStrafe) ? "_left" : ((state & mcRStrafe) ? "_right" : ""), IsMisfire() ? "_jammed_" : "_");
			}
		}
	}
	return nullptr;
...
void CWeaponBM16::PlayAnimDeviceSwitch()
{
	...
	xr_strconcat(guns_device_anm, LaserSwitch ? "anm_laser_on" : (TorchSwitch ? "anm_torch_on" : ((HeadLampSwitch || NightVisionSwitch) ? "anm_headlamp_on" : "")), IsMisfire() ? "_jammed_" : "_", std::to_string(m_magazine.size()).c_str());
