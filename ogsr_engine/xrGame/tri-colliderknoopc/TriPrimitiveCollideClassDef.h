...
\
    public: \
        ...
        IC int CollidePlain(const dReal* triSideAx0, const dReal* triSideAx1, const dReal* triAx, CDB::TRI* T, dReal dist, dxGeom* o1, dxGeom* o2, int flags, \
...
#define TRI_PRIMITIVE_COLIDE_CLASS_IMPLEMENT(primitive) \
    ...
    IC int dcTriListCollider::primitive##Tri::Collide(const dReal* v0, const dReal* v1, const dReal* v2, Triangle* T, dxGeom* o1, dxGeom* o2, int flags, dContactGeom* contact, \
                                                      int skip) \
    { \
        return m_tri_list.dTri##primitive(v0, v1, v2, T, o1, o2, flags, contact, skip); \
    } \
    IC int dcTriListCollider::primitive##Tri::CollidePlain(const dReal* triSideAx0, const dReal* triSideAx1, const dReal* triAx, CDB::TRI* T, dReal dist, dxGeom* o1, dxGeom* o2, \
