...
#define DEFINE_LUA_WRAPPER_METHOD_V3(v_func_name, t1, t2, t3) \
    ...
    static void v_func_name##_static(inherited* ptr, t1 p1, t2 p2, t3 p3) { ptr->self_type::inherited::v_func_name(p1, p2, p3); }
...
#define DEFINE_LUA_WRAPPER_METHOD_V4(v_func_name, t1, t2, t3, t4) \
    ...
    static void v_func_name##_static(inherited* ptr, t1 p1, t2 p2, t3 p3, t4 p4) { ptr->self_type::inherited::v_func_name(p1, p2, p3, p4); }
...
#define DEFINE_LUA_WRAPPER_METHOD_2(v_func_name, ret_type, t1, t2) \
    ...
    static ret_type v_func_name##_static(inherited* ptr, t1 p1, t2 p2) { return ptr->self_type::inherited::v_func_name(p1, p2); }
...
#define DEFINE_LUA_WRAPPER_METHOD_3(v_func_name, ret_type, t1, t2, t3) \
    ...
    static ret_type v_func_name##_static(inherited* ptr, t1 p1, t2 p2, t3 p3) { return ptr->self_type::inherited::v_func_name(p1, p2, p3); }
...
#define DEFINE_LUA_WRAPPER_METHOD_4(v_func_name, ret_type, t1, t2, t3, t4) \
    ...
    static ret_type v_func_name##_static(inherited* ptr, t1 p1, t2 p2, t3 p3, t4 p4) { return ptr->self_type::inherited::v_func_name(p1, p2, p3, p4); }
