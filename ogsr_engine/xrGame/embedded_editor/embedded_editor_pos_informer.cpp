...
void CImGuiPositionInformerWnd::SavePosition()
{
...
void CImGuiPositionInformerWnd::Render()
{
    if (!RenderBegin())
    {
        RenderEnd();
    ...
    ImGui::InputText("section name", (char*)&m_SectionName, 256);
