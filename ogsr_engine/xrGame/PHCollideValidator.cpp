...
#ifdef ANIMATED_PHYSICS_OBJECT_SUPPORT
bool CPHCollideValidator::IsAnimatedObject(const CPHObject& obj) { return !!obj.collide_class_bits().test(cbClassAnimated); }
#endif
...
void CPHCollideValidator::SetCharacterClassNotCollide(CPHObject& obj) { obj.collide_class_bits().set(cbNCClassCharacter, TRUE); }
...
void CPHCollideValidator::SetClassSmallNotCollide(CPHObject& obj) { obj.collide_class_bits().set(cbNCClassSmall, TRUE); }