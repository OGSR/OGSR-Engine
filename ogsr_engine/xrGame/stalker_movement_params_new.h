...
#ifndef STALKER_MOVEMENT_PARAMS_NEW_H_INCLUDED
#define STALKER_MOVEMENT_PARAMS_NEW_H_INCLUDED
...
class CGameObject;
class stalker_movement_manager_obstacles; //stalker_movement_manager_smart_cover;
...
public:
	...
	IC		void				construct				(stalker_movement_manager_obstacles /*stalker_movement_manager_smart_cover*/* manager);
...
private:
	stalker_movement_manager_obstacles /*stalker_movement_manager_smart_cover*/*	m_manager;
/*
...
#include "stalker_movement_params_new_inline.h"

#endif // #ifndef STALKER_MOVEMENT_PARAMS_NEW_H_INCLUDED