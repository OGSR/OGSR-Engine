...
{
    if (m_entry == "vid_mode" || m_entry == "rs_fullscreen" || m_entry == "rs_v_sync" || m_entry == "rs_refresh_60hz" || m_entry == "r2_soft_water" ||
        m_entry == "r2_soft_particles" || m_entry == "r2_dof_enable" || m_entry == "r2_volumetric_lights" || m_entry == "r3_msaa_opt" || m_entry == "r3_dynamic_wet_surfaces" ||
        m_entry == "r__detail_radius" || m_entry == "r__detail_density" || m_entry == "r__detail_scale" || m_entry == "r__no_scale_on_fade" || m_entry == "r2_sun_quality")
