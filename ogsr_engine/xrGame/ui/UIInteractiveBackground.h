...
void CUIInteractiveBackground<T>::SetState(UIState state)
{
    switch (state)
    {
    case S_Enabled: this->m_stateCurrent = this->m_stateEnabled; break;
    case S_Disabled: this->m_stateCurrent = this->m_stateDisabled ? this->m_stateDisabled : this->m_stateEnabled; break;
    case S_Highlighted: this->m_stateCurrent = this->m_stateHighlighted ? this->m_stateHighlighted : this->m_stateEnabled; break;
    case S_Touched: this->m_stateCurrent = this->m_stateTouched ? this->m_stateTouched : this->m_stateEnabled;
    }
}
