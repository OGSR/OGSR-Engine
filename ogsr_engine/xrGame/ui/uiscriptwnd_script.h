...
struct CWrapperBase : public T, public luabind::wrap_base
{
    ...
    virtual bool OnKeyboard(int dik, EUIMessages keyboard_action) { return luabind::call_member<bool>(this, "OnKeyboard", dik, keyboard_action); }
    static bool OnKeyboard_static(inherited* ptr, int dik, EUIMessages keyboard_action) { return ptr->self_type::inherited::OnKeyboard(dik, keyboard_action); }
