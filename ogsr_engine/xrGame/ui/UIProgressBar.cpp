...
void CUIProgressBar::UpdateProgressBar()
{
    ...
    case om_horz:
    case om_back:
    case om_fromcenter: m_CurrentLength = GetWidth() * fCurrentLength; break;
    case om_vert:
    case om_down:
    case om_vfromcenter: m_CurrentLength = GetHeight() * fCurrentLength; break;
    default: m_CurrentLength = 0.0f;
    }
