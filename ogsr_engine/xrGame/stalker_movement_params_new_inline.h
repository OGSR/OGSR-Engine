...
#ifndef STALKER_MOVEMENT_PARAMS_NEW_INLINE_H_INCLUDED
#define STALKER_MOVEMENT_PARAMS_NEW_INLINE_H_INCLUDED

IC	void stalker_movement_params::construct								(stalker_movement_manager_obstacles /*stalker_movement_manager_smart_cover*/* manager)
{
	VERIFY								(!m_manager);
	VERIFY								(manager);
	m_manager							= manager;
...
#endif // #ifndef STALKER_MOVEMENT_PARAMS_NEW_INLINE_H_INCLUDED