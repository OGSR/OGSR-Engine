...
IC const CALifeMonsterPatrolPathManager::EPatrolStartType& CALifeMonsterPatrolPathManager::start_type() const { return (m_start_type); }

IC const CALifeMonsterPatrolPathManager::EPatrolRouteType& CALifeMonsterPatrolPathManager::route_type() const { return (m_route_type); }
...
IC void CALifeMonsterPatrolPathManager::start_vertex_index(const u32& start_vertex_index) { m_start_vertex_index = start_vertex_index; }

IC bool CALifeMonsterPatrolPathManager::use_randomness() const { return (m_use_randomness); }

IC void CALifeMonsterPatrolPathManager::use_randomness(const bool& use_randomness) { m_use_randomness = use_randomness; }
