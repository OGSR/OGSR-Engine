...
IC const MonsterSpace::SBoneRotation& CStalkerMovementManager::head_orientation() const { return (m_head); }

IC void CStalkerMovementManager::set_head_orientation(const MonsterSpace::SBoneRotation& orientation) { m_head = orientation; }
...
IC void CStalkerMovementManager::add_velocity(int mask, float linear, float compute_angular) { add_velocity(mask, linear, compute_angular, compute_angular); }
...
IC bool CStalkerMovementManager::use_desired_position() const { return (m_current.m_use_desired_position); }

IC bool CStalkerMovementManager::use_desired_direction() const { return (m_current.m_use_desired_direction); }
