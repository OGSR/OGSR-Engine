...
void		CPHMovementControl::SetRestrictionType(CPHCharacter::ERestrictionType rt)
{ 
	if( m_character ) 
...
CPHCapture*		CPHMovementControl::		PHCapture			( )
{
	return m_capture; 
}

CPhysicsShellHolder* CPHMovementControl::PhysicsRefObject			()
{
	VERIFY( m_character );
