...
static bool trajectory_check_collision(float low, float high, Fvector const& position, Fvector const& velocity, Fvector const& gravity, CObject* const self_object,
                                       CObject* const ignored_object, Fvector& collide_position, collide::rq_results& temp_rq_results, Fvector box_size,
                                    ...
                                    xr_vector<trajectory_pick>* const out_trajectory_picks, xr_vector<Fvector>* const out_collide_tris, Fvector const& box_size)
{
    ...
    for (;;)
    {
        ...
        if (!trajectory_check_collision(low, time, trajectory_start, trajectory_velocity, gravity, self_object, ignored_object, collide_position, temp_rq_results, box_size,
