...
u16 CPHSimpleCharacter::DamageInitiatorID()const
{
		...
		{
			CObject	* obj = Level().Objects.net_Find(m_collision_damage_info.m_obj_id);
			VERIFY(!obj|| smart_cast<CPhysicsShellHolder*>(obj) );
			object=smart_cast<CPhysicsShellHolder*>(obj);
		}
