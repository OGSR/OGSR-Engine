...
public:
    ...
    static void SetStaticCollide(CPHObject& obj);
    static void SetDynamicCollide(CPHObject& obj);
...
private:
    ...
    {
        return !(((obj1.collide_class_bits().flags & ClassNCFlags.flags) & ((obj2.collide_class_bits().flags & ClassFlags.flags) << 1)) ||
                 ((obj2.collide_class_bits().flags & ClassNCFlags.flags) & ((obj1.collide_class_bits().flags & ClassFlags.flags) << 1)));
    }

    static IC bool DoCollideGroup(const CPHObject& obj1, const CPHObject& obj2) { return !(obj1.collide_bits() == obj2.collide_bits()); }
