...
{
	// â îáùåì, êàêîé òóò ñìûñë. Ñêðèïò áåðåò íà ñåáÿ âñå, êðîìå óñòàíîâêè òåêóùåé ïîãîäû.
	// óñòàíàâëèâàåòñÿ ïîãîäà äâóìÿ äåñêðèïòîðàìè, ñîîòâåòñòâåííî, ÷òîá íå òàùèòü çà ñîáîé êó÷ó âñåãî, 
	// åäèíîìîìåíòíî çàãðóæåí ìèíèìóì ïîãîäíûõ äåñêðèïòîðîâ. Îñòàëüíûå ïîäãðóæàþòñÿ ïî íåîáõîäèìîñòè.
...
//
void send_event_key_press(int dik) //Íàæàòèå êëàâèøè
{
	Level().IR_OnKeyboardPress(dik);
}
void send_event_key_release(int dik) //Îòïóñêàíèå êëàâèøè
{
	Level().IR_OnKeyboardRelease(dik);
}
void send_event_key_hold(int dik) //Óäåðæàíèå êëàâèøè.
{
	Level().IR_OnKeyboardHold(dik);
}
void send_event_mouse_wheel(int vol) //Âðàùåíèå êîëåñà ìûøè
{
...
void CLevel::script_register(lua_State *L)
{
	...
	//óñòàíîâêà ïàðàìåòðîâ äëÿ øåéäåðîâ èç ñêðèïòîâ
	module(L)
		[
