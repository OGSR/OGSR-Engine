...
//}
//
//float evaluate(CEF_Storage* ef_storage, LPCSTR function, CScriptGameObject* _0, CScriptGameObject* _1) { return (evaluate(ef_storage, function, _0, _1, 0, 0)); }
//
//float evaluate(CEF_Storage* ef_storage, LPCSTR function, CScriptGameObject* _0) { return (evaluate(ef_storage, function, _0, 0, 0, 0)); }
//
...
//}
//
//float evaluate(CEF_Storage* ef_storage, LPCSTR function, CSE_ALifeObject* _0, CSE_ALifeObject* _1, CSE_ALifeObject* _2) { return (evaluate(ef_storage, function, _0, _1, _2, 0)); }
//
//float evaluate(CEF_Storage* ef_storage, LPCSTR function, CSE_ALifeObject* _0, CSE_ALifeObject* _1) { return (evaluate(ef_storage, function, _0, _1, 0, 0)); }
//
