...
TEMPLATE_SPECIALIZATION
bool CStateMonsterAttackMeleeAbstract::check_start_conditions() { return (object->MeleeChecker.can_start_melee(object->EnemyMan.get_enemy()) && object->EnemyMan.see_enemy_now()); }

TEMPLATE_SPECIALIZATION
bool CStateMonsterAttackMeleeAbstract::check_completion() { return (object->MeleeChecker.should_stop_melee(object->EnemyMan.get_enemy())); }