...
//.	FS.update_path			(fn,_textures_,ChangeFileExt(src_name,".tga").c_str());
	FS.update_path			(fn,_game_textures_,PAnsiChar(ChangeFileExt(src_name,".dds").c_str()));
    u32 a;
...
void __stdcall CImageManager::RemoveTexture(LPCSTR fname, EItemType type, bool& res)
{
	if (TYPE_FOLDER==type){
