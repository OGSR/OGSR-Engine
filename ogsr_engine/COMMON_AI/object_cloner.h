...
struct CCloner
{
    ...
    IC static void clone(LPCSTR __1, LPCSTR& __2) { __2 = __1; }

    IC static void clone(LPSTR __1, LPSTR& __2) { __2 = xr_strdup(__1); }

    IC static void clone(const shared_str& __1, shared_str& __2) { __2 = __1; }
