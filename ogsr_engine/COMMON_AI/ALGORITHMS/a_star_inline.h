...
TEMPLATE_SPECIALIZATION
 CSAStar::CAStar(const u32 max_vertex_count) : Inherited(max_vertex_count) {}
TEMPLATE_SPECIALIZATION
 CSAStar::~CAStar() = default;
TEMPLATE_SPECIALIZATION
template <typename TPathManager>
 void CSAStar::initialize(TPathManager& path_manager)
{
...
TEMPLATE_SPECIALIZATION
template <typename TPathManager>
 bool CSAStar::step(TPathManager& path_manager)
{
    auto& data_storage = this->data_storage();
...
TEMPLATE_SPECIALIZATION
template <typename TPathManager>
 bool CSAStar::find(TPathManager& path_manager)
{
