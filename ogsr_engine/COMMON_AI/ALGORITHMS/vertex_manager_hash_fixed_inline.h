...
TEMPLATE_SPECIALIZATION
 CHashFixedVertexManager::CDataStorage(const u32 vertex_count) : CDataStorageBase(vertex_count), CDataStorageAllocator(), m_current_path_id(PathId(0))
{
...
TEMPLATE_SPECIALIZATION
 void CHashFixedVertexManager::init()
{
...
TEMPLATE_SPECIALIZATION
 void CHashFixedVertexManager::add_opened(Vertex& vertex) { vertex.opened() = 1; }
TEMPLATE_SPECIALIZATION
 void CHashFixedVertexManager::add_closed(Vertex& vertex) { vertex.opened() = 0; }
TEMPLATE_SPECIALIZATION
 CHashFixedVertexManagerT::PathId CHashFixedVertexManager::current_path_id() const { return m_current_path_id; }

TEMPLATE_SPECIALIZATION
 bool CHashFixedVertexManager::is_opened(const Vertex& vertex) const { return vertex.opened(); }
TEMPLATE_SPECIALIZATION
 u32 CHashFixedVertexManager::hash_index(const Index& vertex_id) const { return hash_fixed_vertex_manager::to_u32(vertex_id) % HashSize; }

TEMPLATE_SPECIALIZATION
 bool CHashFixedVertexManager::is_visited(const Index& vertex_id) const
{
...
TEMPLATE_SPECIALIZATION
 bool CHashFixedVertexManager::is_closed(const Vertex& vertex) const { return !is_opened(vertex); }
TEMPLATE_SPECIALIZATION
 CHashFixedVertexManagerT::Vertex& CHashFixedVertexManager::get_node(const Index& vertex_id) const
{
...
TEMPLATE_SPECIALIZATION
 CHashFixedVertexManagerT::Vertex& CHashFixedVertexManager::create_vertex(Vertex& vertex, const Index& vertex_id)
{
