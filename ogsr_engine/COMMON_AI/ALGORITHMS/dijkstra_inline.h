...
TEMPLATE_SPECIALIZATION
 CSDijkstra::CDijkstra(const u32 max_vertex_count)
{
...
TEMPLATE_SPECIALIZATION
CSDijkstra::CDataStorage& CSDijkstra::data_storage() { return *m_data_storage; }
TEMPLATE_SPECIALIZATION
 const CSDijkstra::CDataStorage& CSDijkstra::data_storage() const { return *m_data_storage; }
TEMPLATE_SPECIALIZATION
template <typename TPathManager>
 void CSDijkstra::initialize(TPathManager& path_manager)
{
...
TEMPLATE_SPECIALIZATION
template <typename TPathManager>
 void CSDijkstra::finalize(TPathManager& path_manager)
{
...
TEMPLATE_SPECIALIZATION
template <typename TPathManager>
 bool CSDijkstra::step(TPathManager& path_manager)
{
...
TEMPLATE_SPECIALIZATION
template <typename TPathManager>
 bool CSDijkstra::find(TPathManager& path_manager)
{
