    ...
    module(
        L)[def("vector", &initialize_vector),
           class_<Fvector>("___VECTOR")
               ...
               //return_reference_to(_1)) 			.def("random_dir",					(Fvector & (Fvector::*)(const Fvector &, float))(&Fvector::random_dir),
               //return_reference_to(_1)) 			.def("random_point",				(Fvector & (Fvector::*)(const Fvector &))(&Fvector::random_point),
               //return_reference_to(_1)) 			.def("random_point",				(Fvector & (Fvector::*)(float))(&Fvector::random_point),
               //return_reference_to(_1))
               ...
               //return_reference_to(_1)) 			.def("from_bary",					(Fvector & (Fvector::*)(const Fvector &, const Fvector &, const Fvector &, const Fvector
               //&))(&Fvector::from_bary),		return_reference_to(_1)) 			.def("from_bary4",					&Fvector::from_bary4,
