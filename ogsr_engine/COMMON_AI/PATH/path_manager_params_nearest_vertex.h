...
struct SNearestVertex : public SBaseParameters<_dist_type, _index_type, _iteration_type>
{
    ...
    IC SNearestVertex(const Fvector& target_position, _dist_type max_range = _dist_type(6000), _iteration_type max_iteration_count = _iteration_type(-1),
                      u32 max_visited_node_count = u32(-1))
        : SBaseParameters<_dist_type, _index_type, _iteration_type>(max_range, max_iteration_count, max_visited_node_count), m_target_position(target_position)
    {}
};
