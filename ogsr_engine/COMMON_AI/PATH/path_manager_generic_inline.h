...
TEMPLATE_SPECIALIZATION
IC void CGenericPathManager::setup(const _Graph* _graph, _DataStorage* _data_storage, xr_vector<_index_type>* _path, const _index_type& _start_node_index,
...
TEMPLATE_SPECIALIZATION
IC bool CGenericPathManager::is_goal_reached(const _index_type& vertex_id) const { return (vertex_id == goal_node_index); }
...
TEMPLATE_SPECIALIZATION
IC const _index_type CGenericPathManager::get_value(const_iterator& i) const { return (graph->value(*best_node_index, i)); }

TEMPLATE_SPECIALIZATION
IC void CGenericPathManager::finalize() {}

TEMPLATE_SPECIALIZATION
IC const typename CGenericPathManager::const_iterator& CGenericPathManager::edge(const_iterator& i) const { return (i); }
