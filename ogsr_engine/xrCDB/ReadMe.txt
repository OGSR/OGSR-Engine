 ...
 -----------------------
	...
	code, but the newer one seems better. Tim Schrцder's one is good as well. See: www.codercorner.com/RayAABB.cpp
 ...
 WHAT ?
    ...
    - Supports "first contact" or "all contacts" modes (а la RAPID)
