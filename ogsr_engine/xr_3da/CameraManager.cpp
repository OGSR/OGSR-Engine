...
#pragma todo("KRodin: надо придумать какую-то формулу, чтобы кратность 3D прицела была одинаковой независимо от FOV. Тут попробовал сделать как с рассчётом зум_фактора, но получилось что-то странное.")
