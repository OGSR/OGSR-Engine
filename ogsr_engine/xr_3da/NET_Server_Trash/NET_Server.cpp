...
void ip_address::set(LPCSTR src_string) //Ёто нужно
{
	u32		buff[4];
...
IPureServer::EConnect IPureServer::Connect(LPCSTR options) // опции вида [им€_сейва/single/alife]
{
...
void	IPureServer::SendTo		(ClientID ID/*DPNID ID*/, NET_Packet& P, u32 dwFlags, u32 dwTimeout) //ќтсюда отправл€ютс€ данные в IPureClient::OnMessage
{
...
void	IPureServer::SendBroadcast_LL(ClientID exclude, void* data, u32 size, u32 dwFlags) //ќтсюда отправл€ютс€ данные в IPureClient::OnMessage
{
	csPlayers.Enter();
