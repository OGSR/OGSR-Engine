...
void CAI_Stalker::reinit			()
{
	...
	//загрузка спецевической звуковой схемы дл€ сталкера согласно m_SpecificCharacter
...
#pragma todo("KD: ѕоскольку весь лут непис€ пока обрабатываетс€ в скриптах, в этом месте отключено удаление лута")
#if 0
