...
// Включает только FuncDbg и ASSERT_FMT_DBG
//#define OGSR_TOTAL_ASSERT
...
// Включает вылет, если в задании будет указан не существующий story_id для
// метки или обьекта с таким story_id не будет.
//#define CRASH_ON_INVALID_STORY_ID
...
// Так же, в этом режиме отключено распознавание произвольного lua кода в теге
// <action>. Там можно использовать только полное имя функции.
