...
// Включает подсветку патронов и аддонов для выбранного оружия в окнах инвентаря, торговли и обыска.
// Что-то на подобии ЗП. Цвет подсветки можно переопределить в конфигах, добавив куда-нибудь в system.ltx:
// [inventory_color_ammo]
// color = 212, 8, 185, 255 ;RGBA
