...
ID3D11BlendState* ImGui_ImplDX11_GetBlendState()
{
    ImGui_ImplDX11_Data* dx11_data = ImGui_ImplDX11_GetBackendData();
    return dx11_data ? dx11_data->pBlendState : nullptr;
}
