...
void CRenderTarget::phase_smap_spot_clear(CBackend& cmd_list)
{
    ...
    rt_smap_lights->set_slice_write(cmd_list.context_id, cmd_list.context_id);
    cmd_list.set_pass_targets(nullptr, nullptr, nullptr, nullptr, rt_smap_lights);
    cmd_list.ClearZB(rt_smap_lights, 1.0f);
}
