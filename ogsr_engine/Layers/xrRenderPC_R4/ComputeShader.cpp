...
void ComputeShader::Construct(ID3D11ComputeShader* cs, ref_ctable ctable, xr_vector<ID3D11SamplerState*>& Samplers, xr_vector<ID3D11ShaderResourceView*>& Textures,
