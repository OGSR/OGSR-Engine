...
public:
    ...
    virtual void dbgDrawPlacement(const Fvector& p, int sz, u32 clr, LPCSTR caption = nullptr, u32 clr_font = 0xffffffff) = 0;
    virtual void dbgDrawVert(const Fvector& p0, u32 clr, LPCSTR caption = nullptr) = 0;
    virtual void dbgDrawEdge(const Fvector& p0, const Fvector& p1, u32 clr, LPCSTR caption = nullptr) = 0;
    virtual void dbgDrawFace(const Fvector& p0, const Fvector& p1, const Fvector& p2, u32 clr, LPCSTR caption = nullptr) = 0;
