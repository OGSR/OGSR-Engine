# Microsoft Developer Studio Project File - Name="MagicFM" - Package Owner=<4>
# Microsoft Developer Studio Generated Build File, Format Version 6.00
# ** DO NOT EDIT **

# TARGTYPE "Win32 (x86) Static Library" 0x0104

CFG=MagicFM - Win32 Debug
!MESSAGE This is not a valid makefile. To build this project using NMAKE,
!MESSAGE use the Export Makefile command and run
!MESSAGE 
!MESSAGE NMAKE /f "MagicFM.mak".
!MESSAGE 
!MESSAGE You can specify a configuration when running NMAKE
!MESSAGE by defining the macro CFG on the command line. For example:
!MESSAGE 
!MESSAGE NMAKE /f "MagicFM.mak" CFG="MagicFM - Win32 Debug"
!MESSAGE 
!MESSAGE Possible choices for configuration are:
!MESSAGE 
!MESSAGE "MagicFM - Win32 Release" (based on "Win32 (x86) Static Library")
!MESSAGE "MagicFM - Win32 Debug" (based on "Win32 (x86) Static Library")
!MESSAGE 
...
# ADD LIB32 /nologo /out:"..\Library\Release\MagicFM.lib"
...
PostBuild_Cmds=copy Approximation2D\*.h ..\Include	copy Approximation2D\*.pkg ..\Include	copy Approximation3D\*.h ..\Include	copy Approximation3D\*.pkg ..\Include	copy Containment2D\*.h ..\Include	copy Containment2D\*.inl ..\Include	copy Containment2D\*.pkg ..\Include	copy Containment3D\*.h ..\Include	copy Containment3D\*.inl ..\Include	copy Containment3D\*.pkg ..\Include	copy Core\*.h ..\Include	copy Core\*.inl ..\Include	copy Core\*.pkg ..\Include	copy Core2D\*.h ..\Include	copy Core2D\*.inl ..\Include	copy Core2D\*.pkg ..\Include	copy Core3D\*.h ..\Include	copy Core3D\*.inl ..\Include	copy Core3D\*.pkg ..\Include	copy Curve2D\*.h ..\Include	copy Curve2D\*.inl ..\Include	copy Curve2D\*.pkg ..\Include	copy Curve3D\*.h ..\Include	copy Curve3D\*.inl ..\Include	copy Curve3D\*.pkg ..\Include	copy Distance2D\*.h ..\Include	copy Distance2D\*.pkg ..\Include	copy Distance3D\*.h ..\Include	copy Distance3D\*.pkg ..\Include	copy ImageAnalysis\*.h ..\Include	copy ImageAnalysis\*.inl ..\Include	copy ImageAnalysis\*.pkg ..\Include	copy Interpolation1D\*.h ..\Include	copy Interpolation1D\*.inl ..\Include	copy Interpolation1D\*.pkg ..\Include	copy Interpolation2D\*.h ..\Include	copy\
                                    Interpolation2D\*.inl ..\Include	copy Interpolation2D\*.pkg ..\Include	copy Interpolation3D\*.h ..\Include	copy Interpolation3D\*.inl ..\Include	copy Interpolation3D\*.pkg ..\Include	copy Intersection2D\*.h ..\Include	copy Intersection2D\*.pkg ..\Include	copy Intersection3D\*.h ..\Include	copy Intersection3D\*.pkg ..\Include	copy Numerics\*.h ..\Include	copy Numerics\*.inl ..\Include	copy Numerics\*.pkg ..\Include	copy Projection\*.h ..\Include	copy Projection\*.inl ..\Include	copy Projection\*.pkg ..\Include	copy Surface\*.h ..\Include	copy Surface\*.inl ..\Include	copy Surface\*.pkg ..\Include	copy Tessellation2D\*.h ..\Include	copy Tessellation2D\*.inl ..\Include	copy Tessellation2D\*.pkg ..\Include	copy Tessellation3D\*.h ..\Include	copy Tessellation3D\*.inl ..\Include	copy Tessellation3D\*.pkg ..\Include	copy MgcRTLib.h ..\Include	copy MagicFMLibType.h ..\Include	copy MagicFM.pkg  ..\Include	copy ..\Include\*.h ..\..\Sdk\Include	copy ..\Include\*.inl ..\..\Sdk\Include	copy ..\Include\*.pkg ..\..\Sdk\Include	copy ..\Library\$(OutDir)\MagicFM.lib ..\..\Sdk\Library\$(OutDir)
# End Special Build Tool

!ELSEIF  "$(CFG)" == "MagicFM - Win32 Debug"
...
# ADD CPP /nologo /G5 /MDd /W3 /Gm /GX /ZI /Od /I ".\\" /I "Approximation2D" /I "Approximation3D" /I "Containment2D" /I "Containment3D" /I "Core" /I "Core2D" /I "Core3D" /I "Curve2D" /I "Curve3D" /I "Distance2D" /I "Distance3D" /I "ImageAnalysis" /I "Interpolation1D" /I "Interpolation2D" /I "Interpolation3D" /I "Intersection2D" /I "Intersection3D" /I "Numerics" /I "Projection" /I "Surface" /I "Tessellation2D" /I "Tessellation3D" /D "_DEBUG" /D "WIN32" /D "_MBCS" /D "_LIB" /D "STRICT" /YX /FD /GZ /c
# SUBTRACT CPP /Fr
...
LIB32=link.exe -lib
# ADD BASE LIB32 /nologo
# ADD LIB32 /nologo /out:"..\Library\Debug\MagicFM.lib"
# Begin Special Build Tool
OutDir=.\Debug
SOURCE="$(InputPath)"
PostBuild_Cmds=copy Approximation2D\*.h ..\Include	copy Approximation2D\*.pkg ..\Include	copy Approximation3D\*.h ..\Include	copy Approximation3D\*.pkg ..\Include	copy Containment2D\*.h ..\Include	copy Containment2D\*.inl ..\Include	copy Containment2D\*.pkg ..\Include	copy Containment3D\*.h ..\Include	copy Containment3D\*.inl ..\Include	copy Containment3D\*.pkg ..\Include	copy Core\*.h ..\Include	copy Core\*.inl ..\Include	copy Core\*.pkg ..\Include	copy Core2D\*.h ..\Include	copy Core2D\*.inl ..\Include	copy Core2D\*.pkg ..\Include	copy Core3D\*.h ..\Include	copy Core3D\*.inl ..\Include	copy Core3D\*.pkg ..\Include	copy Curve2D\*.h ..\Include	copy Curve2D\*.inl ..\Include	copy Curve2D\*.pkg ..\Include	copy Curve3D\*.h ..\Include	copy Curve3D\*.inl ..\Include	copy Curve3D\*.pkg ..\Include	copy Distance2D\*.h ..\Include	copy Distance2D\*.pkg ..\Include	copy Distance3D\*.h ..\Include	copy Distance3D\*.pkg ..\Include	copy ImageAnalysis\*.h ..\Include	copy ImageAnalysis\*.inl ..\Include	copy ImageAnalysis\*.pkg ..\Include	copy Interpolation1D\*.h ..\Include	copy Interpolation1D\*.inl ..\Include	copy Interpolation1D\*.pkg ..\Include	copy Interpolation2D\*.h ..\Include	copy\
...
# Name "MagicFM - Win32 Release"
# Name "MagicFM - Win32 Debug"
...
SOURCE=.\ImageAnalysis\MgcBinary3D.cpp
# End Source File
# Begin Source File
...
SOURCE=.\ImageAnalysis\MgcBinary3D.h
# End Source File
# Begin Source File
...
SOURCE=.\Interpolation3D\MgcInterp3DLinearNonuniform.cpp
# End Source File
# Begin Source File
...
SOURCE=.\Interpolation3D\MgcInterp3DLinearNonuniform.h
# End Source File
# Begin Source File
