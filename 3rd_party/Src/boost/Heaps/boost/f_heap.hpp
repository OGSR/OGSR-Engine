...
// Version: $Id: f_heap.hpp,v 1.4 1999/07/13 01:42:09 kuehl Exp $ 
...
//    node()  {}
	...
	void	  set(T const& data) {m_parent=0; m_lost_child=0; m_index = size_type(-1); m_children.clear(); m_children.reserve(8); m_data = data;}
...
//  void		clear() {m_size = 0; reserve_count = 0; m_roots.clear();}
  void		clear() {m_size = 0; m_roots.clear();}
